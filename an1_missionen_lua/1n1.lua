-- dekompiliert aus map\1n1\script\1n1.sco
...
__InitLayout = function()
  ...
  Game_LoadProgress_Advance(node0)
  node72 = Node_CreateNode("nod_vessel", "gen_transp_1")
  Node_AddSon(node71, node72)
  Body_SetCS(node72, MAT_Vector3(2308.454464, 806.243302, 271.503108), MAT_Vector3(174.283551, 0, 0))
  ...
  Game_LoadProgress_Advance(node0)
  node73 = Node_CreateNode("nod_vessel", "gen_transp_2")
  Node_AddSon(node71, node73)
  Body_SetCS(node73, MAT_Vector3(1920.592872, 1305.126333, 380.774477), MAT_Vector3(38.50412, 0, 0))
  Node_ParseIniFile(node73, "osd/gen/gen_freighter2.osd")
  ...
  Game_LoadProgress_Advance(node0)
  node74 = Node_CreateNode("nod_vessel", "gen_drowsymaggie_1")
  Node_AddSon(node71, node74)
  Body_SetCS(node74, MAT_Vector3(2145.750584, 1005.633961, 315.004894), MAT_Vector3(0, 0, 0))
  Node_ParseIniFile(node74, "osd/gen/gen_drowsymaggie.osd")
  ...
  Game_LoadProgress_Advance(node0)
  node75 = Node_CreateNode("nod_vessel", "gen_toiler_1")
  Node_AddSon(node71, node75)
  Body_SetCS(node75, MAT_Vector3(2356.146586, 921.837649, 328.471788), MAT_Vector3(0, 0, 0))
  ...
  Game_LoadProgress_Advance(node0)
  node76 = Node_CreateNode("nod_vessel", "gen_toiler_2")
  Node_AddSon(node71, node76)
  Body_SetCS(node76, MAT_Vector3(2363.182157, 707.142418, 328.471788), MAT_Vector3(0, 0, 0))
  Node_ParseIniFile(node76, "osd/gen/gen_toiler.osd")
  ...
  Game_LoadProgress_Advance(node0)
  node77 = Node_CreateNode("nod_vessel", "gen_toiler_3")
  Node_AddSon(node71, node77)
  Body_SetCS(node77, MAT_Vector3(1902.475441, 963.7331, 328.471788), MAT_Vector3(0, 0, 0))
  Node_ParseIniFile(node77, "osd/gen/gen_toiler.osd")
  ...
  Game_LoadProgress_Advance(node0)
  node78 = Node_CreateNode("nod_vessel", "terror")
  Node_AddSon(node70, node78)
  Body_SetCS(node78, MAT_Vector3(2407.176136, 886.478492, 382.627949), MAT_Vector3(0, 0, 0))
  Node_ParseIniFile(node78, "osd/atl/atl_bomber_b.osd")
  Body_SetFriendOrFoeID(node78, 1)
  Body_SetNameKey(node78, 10)
  Body_SetCargoKey(node78, 1127, 0)
  Body_SetCargoKey(node78, 1126, 1)
  Body_SetCargoKey(node78, 1125, 2)
  Node_EnterSimulation(node78)
  Game_LoadProgress_Advance(node0)
  node79 = Node_CreateNode("nod_player", "player1")
  Node_AddSon(node70, node79)
  Body_SetCS(node79, MAT_Vector3(2102.545964, 1537.18958, 421.80143), MAT_Vector3(-157.452218, 0, 0))
  Node_ParseIniFile(node79, "osd/pla/pla_toiler.osd")
...
__StartUp = function()
  Game_LoadProgress_Enter(Node_Find("/"), 94)
  __InitLayout()
  __InitLayout = nil
  ...
  o1451 = BindEasy(Node_Find("/Scenario_Dynamic/Object/TRAFFIC"), "gen_drowsymaggie_1", S_o1451)
  o1499 = BindEasy(Node_Find("/Scenario_Dynamic/Object/TRAFFIC"), "gen_toiler_1", S_o1499)
  o1547 = BindEasy(Node_Find("/Scenario_Dynamic/Object/TRAFFIC"), "gen_toiler_2", S_o1547)
  o1595 = BindEasy(Node_Find("/Scenario_Dynamic/Object/TRAFFIC"), "gen_toiler_3", S_o1595)
  o1643 = BindEasy(Node_Find("/Scenario_Dynamic/Object"), "terror", S_o1643)
  o1648.Start()
  o1649.Start()
  o1655.Start()
  o1656.Start()
  o1692 = BindEasy(Node_Find("/Scenario_Dynamic/Object"), "player1", S_o1692)
  o1729 = BindEasy(Node_Find("/Scenario_Dynamic/Object"), "nav_waypoint_attack_1", S_o1729)
  o1734 = BindEasy(Node_Find("/"), "Camera", S_o1734)
  o1737 = BindEasy(Node_Find("/InGameSequences/Navigation"), "Position_1", S_o1737)
  o1738 = BindEasy(Node_Find("/InGameSequences/Navigation"), "Position_2", S_o1738)
  o1739 = BindEasy(Node_Find("/InGameSequences/Director"), "Chapter1IntroV", S_o1739)
  o1744 = BindEasy(Node_Find("/InGameSequences/Director"), "Chapter1IntroAddon", S_o1744)
  o1735 = { {}, o1692 }()
