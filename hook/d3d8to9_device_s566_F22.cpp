...
void Direct3DDevice8::AqVorZeichnen()
{
	...
	if (AqVS3 && (AqVS3Aktiv || AqVSLicht))
	{
		...
		if ((AqZaehlVS3Draw % 4000) == 0)
			LOG << "> AquaNox-MESSUNG: vs_3_0-Zeichenaufrufe " << AqZaehlVS3Draw
			    ...
			    << ", OHNE Pixelshader " << AqZaehlOhnePS
			    << "  [A Schluessel=" << AqWegA
			    << " B Erzeugung=" << AqWegB
			    << " C nicht zustaendig=" << AqWegC << " C-Nachbau=" << AqWegC2 << "]" << std::endl;
#endif
	}
	...
	{
		if (AqVS3 && (AqVS3Aktiv || AqVSLicht) && CurrentVertexShaderHandle != 0
			&& CurrentPixelShaderHandle == 0)
		{
	...
	if (!Zustaendig)
	{
		...
		if (Gewuenscht == nullptr && AqVS3 && (AqVS3Aktiv || AqVSLicht)
		...
		if (Gewuenscht == nullptr && AqVS3 && (AqVS3Aktiv || AqVSLicht) && CurrentVertexShaderHandle != 0)
	...
	if (!AqBaueSchluessel(k))
	{
		...
		if (AqVS3 && (AqVS3Aktiv || AqVSLicht)) ++AqZaehlOhnePS;
	...
	if (PS == nullptr && AqVS3 && (AqVS3Aktiv || AqVSLicht))
		PS = AqHoleNotPS();
		++AqZaehlNotPS;
		++AqWegB;
