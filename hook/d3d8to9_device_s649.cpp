...
// Kaustik-Unterdrueckung (644): der Zug faellt ganz aus, wenn seine
// Stufe-0-Textur ein Kaustik-Frame ist UND er ueberhaupt blendet --
// ein Kaustik-Pass mischt IMMER (additiv oder modulierend, 612),
// waehrend die Blend-Bedingung theoretische deckende Zuege mit
// derselben Textur schuetzt. Nicht enger auf Dest=ONE gefiltert:
// der exakte Blendmodus ist im Protokoll nicht belegt. VOR
// AqVorZeichnen, damit kein Zustand angefasst wird; der naechste
// Zug bindet seinen eigenen.
bool Direct3DDevice8::AqKaustikZug() const
{
	return AqKaustikAus && AqBlendAn
