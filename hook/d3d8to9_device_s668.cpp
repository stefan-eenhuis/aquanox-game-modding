...
// Kaustik-Unterdrueckung (644, verschaerft 650): der Zug faellt
// ganz aus, wenn seine Stufe-0-Textur ein Kaustik-Frame ist UND er
// ADDITIV mischt (Dest=ONE, wie die Kaustik laut 612). Die 644er-
// Lockerung auf "irgendein Blend" war ein unnoetiges Risiko: die
// Schiffs-BASIS laeuft mit SRCALPHA/INVSRCALPHA (650-Forensik) --
// bei einer Hash-Kollision haette der Skip ganze Schiffe lautlos
// verschluckt, ohne jeden Fehlerzaehler. Jeder Treffer wird jetzt
...
{
	if (!AqKaustikAus || !AqBlendAn || AqDestBlend != D3DBLEND_ONE
		|| AqKaustikHashes.count(AqHash0) == 0)
		return false;
#ifndef D3D8TO9NOLOG
...
void Direct3DDevice8::AqInit(DWORD BehaviorFlags)
{
	...
	// AQUANOX_KAUSTIK=0: die additiven Kaustik-Zuege unterdruecken
	// (644, Stefans Wunsch -- Screenshots ohne das wandernde Licht-
	// netz auswerten). Die Hashes liefert mod_docu\texturen\
	// kaustik_hashes.txt (Bildabgleich-Inventur); ohne Datei bleibt
	// der Schalter wirkungslos und meldet das.
	char KJ[8] = {};
...
#ifndef D3D8TO9NOLOG
		LOG << "> AquaNox-KAUSTIK: " << (AqKaustikAus ? "aus, " : "DATEI FEHLT/LEER, ")
		    << AqKaustikHashes.size() << " Hashes." << std::endl;
#endif
	}
