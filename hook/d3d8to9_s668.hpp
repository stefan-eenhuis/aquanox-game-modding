...
private:
	...
	static_assert(sizeof(AqSchluessel) == 38, "AqSchluessel darf keine Fuellbytes haben");
	...
	// AQUANOX_KAUSTIK=0: additive Kaustik-Zuege unterdruecken (644,
	// fuer auswertbare Screenshots). Hashes aus kaustik_hashes.txt.
