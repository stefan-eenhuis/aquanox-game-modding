...
private:
	...
	float AqVSK[8][4] = {};
	// 671: Schatten der vs-Register c15/c16 -- die Engine laedt dort
	// die Parameter ihrer Terrain-Selektor-UV-Formel
	// (oT1 = (v0.xy + c15) * c16) hoch, auch wenn der Detail-VS
	// (rep_terrainprelit_vs_dmfm) die Formel selbst nicht rechnet.
	// Der 23er-Bindungspfad spiegelt beide als EIN ps-Register
	// (c7 = c15.xy, c16.xy) fuer die TERRAINMIX=2-Vollvariante;
	// der 668er-Kamera-Differenz-Weg ist tot (Messlauf 671:
	// WeltKam=0 -- die Engine setzt SetTransform(VIEW) NIE).
	float AqVSC15[4] = {};
	float AqVSC16[4] = {};
	bool AqVSC15Gueltig = false;   // Frische-Flags: je einmal gesetzt?
	bool AqVSC16Gueltig = false;
